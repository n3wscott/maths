...
import (
	...
	"tableflip.dev/maths/pkg/client/clientset/versioned/scheme"
)
...
// NewForConfigAndClient creates a new MathsV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*MathsV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
