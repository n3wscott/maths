...
import (
	...
	fake "tableflip.dev/maths/pkg/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch tableflip.dev/maths/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
