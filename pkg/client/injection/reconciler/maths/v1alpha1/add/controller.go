...
import (
	...
	add "tableflip.dev/maths/pkg/client/injection/informers/maths/v1alpha1/add"
)

const (
	defaultControllerAgentName = "add-controller"
	defaultFinalizerName       = "adds.maths.tableflip.dev"
)
