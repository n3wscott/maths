...
import (
	...
	versionedscheme "tableflip.dev/maths/pkg/client/clientset/versioned/scheme"
	client "tableflip.dev/maths/pkg/client/injection/client"
	subtract "tableflip.dev/maths/pkg/client/injection/informers/maths/v1alpha1/subtract"
)

const (
	defaultControllerAgentName = "subtract-controller"
	defaultFinalizerName       = "subtracts.maths.tableflip.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	subtractInformer := subtract.Get(ctx)

	lister := subtractInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "maths.tableflip.dev.Subtract"),
	)
