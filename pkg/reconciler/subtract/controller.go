...
import (
	...
	subtractinformer "tableflip.dev/maths/pkg/client/injection/informers/maths/v1alpha1/subtract"
...
func NewController(
	...
	subtractInformer := subtractinformer.Get(ctx)
	resultsInformer := resultsinformer.Get(ctx)

	r := &Reconciler{}
	impl := subtractreconciler.NewImpl(ctx, r)
	...
	subtractInformer.Informer().AddEventHandler(controller.HandleAll(impl.Enqueue))
